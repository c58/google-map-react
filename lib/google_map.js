...
var GoogleMap = (function(_Component) {
          ...
          var overlay = Object.assign(new maps.OverlayView(), {
            onAdd: function onAdd() {
              ...
              if (this_.props.overlayViewDivStyle) {
                ...
                if (
                  (typeof overlayViewDivStyle === 'undefined'
                    ? 'undefined'
                    : _typeof(overlayViewDivStyle)) === 'object'
                ) {
            ...
            onRemove: function onRemove() {
              var overlay = this_.state.overlay;
            ...
            draw: function draw() {
              ...
              if (this_.mouse_) {
                var latLng = this_.geoService_.fromContainerPixelToLatLng(
                  this_.mouse_
                );
  ...
  GoogleMap.prototype.render = function render() {
    ...
    var mapMarkerPrerender = !overlay
